...
<header id="header">
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-header">
            <a class="btn btn-transparent btn-equal btn-menu" href="javascript:void(0);"><i
        ...
        <div class="collapse navbar-collapse" id="header-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><span class="navbar-text"><strong><?php echo CHtml::encode(Yii::app()->name); ?></strong></span>
                </li>
    ...
    <div id="sidebar" class="sidebar-fixed">
        ...
        <div class="sidebar-content">
            ...
            $this->widget('zii.widgets.CMenu', array(
                ...
                'items' => array(
                    array('label' => '<i class="fa fa-home"></i> <span class="title">Партнёрка</span>', 'url' => array('default/index'), 'linkOptions' => array('class' => 'linkbtn')),
                    ...
                    array('label' => '<i class="fa fa-users"></i> <span class="title" >Сертификаты</span>', 'url' => array('sertifikat/index'), 'linkOptions' => array('class' => 'linkbtn')),
